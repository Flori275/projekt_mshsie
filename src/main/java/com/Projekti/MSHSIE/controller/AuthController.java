...
import com.Projekti.MSHSIE.dto.auth.AuthReq;
import com.Projekti.MSHSIE.dto.auth.TokenDTO;
...
public class AuthController {
    ...
    public ResponseEntity<UserDTO> registerUser(UserDTO req){
        return ResponseEntity.ok(userService.registerUser(req,"ADMIN"));
